...
//   const [error, setError] = useState('');
//   const [success, setSuccess] = useState(false);
//   const [loginStep, setLoginStep] = useState('idle'); // idle, connecting, authenticating, verifying, success, error
...
//     console.log('🚀 === CBE KYC LOGIN STARTED ===');
...
//     try {
//       // Step 1: Connecting to CBE LDAP Server
//       console.log('📡 STEP 1: Connecting to CBE LDAP Server...');
//       await new Promise(resolve => setTimeout(resolve, 1000));
//       setLoginStep('authenticating');
//       console.log('✅ STEP 1: LDAP Server Connected!');

//       // Step 2: Authenticating Credentials
//       console.log('🔐 STEP 2: Authenticating credentials...');
//       await new Promise(resolve => setTimeout(resolve, 2000));
//       setLoginStep('verifying');
//       console.log('✅ STEP 2: Credentials Validated!');

//       // Step 3: Verifying Employee Profile
//       console.log('👥 STEP 3: Verifying employee profile...');
//       await new Promise(resolve => setTimeout(resolve, 1500));
//       setLoginStep('success');
//       console.log('✅ STEP 3: Employee Profile Verified!');

//       // Step 4: Generate Session
//       console.log('🎫 STEP 4: Generating secure session...');
//       await new Promise(resolve => setTimeout(resolve, 1000));
...
//           isAdmin: true
//         },
//         sessionId: "cbe-kyc-sess-abc123xyz"
//       };

//       console.log('🎉 === LOGIN SUCCESSFUL! ===');
//       console.log('👤 User:', fakeResponse.user);
//       console.log('🎫 Session:', fakeResponse.sessionId);
      
//       setSuccess(true);
      
//       // Final Success Display + Redirect
//       console.log('⏳ Showing success message for 2 seconds...');
//       setTimeout(() => {
...
//   const getLoginStepMessage = () => {
//     const messages = {
//       connecting: '📡 Connecting to CBE LDAP Server...',
//       authenticating: '🔐 Authenticating with LDAP Directory...',
//       verifying: '👥 Verifying Employee Profile...',
//       success: '🎉 Welcome to CBE KYC Portal!'
//     };
//     return messages[loginStep] || '';
//   };
...
//         {/* Left Side - Logo & Branding */}
//         <div className="w-full lg:w-1/2 xl:w-2/5 h-auto lg:h-full flex flex-col items-center justify-center text-center px-4 lg:px-8 xl:px-12 py-8 lg:py-12 xl:py-16">
//           <div className="mx-auto w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 xl:w-40 xl:h-40 2xl:w-44 2xl:h-44 bg-gradient-to-r from-fuchsia-800 via-rose-700 to-pink-700 rounded-full flex items-center justify-center shadow-2xl shadow-fuchsia-800/50 ring-2 ring-fuchsia-800/40 animate-pulse">
//             <svg className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-18 lg:h-18 xl:w-20 xl:h-20 2xl:w-22 text-white drop-shadow-2xl" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//               <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
//             </svg>
//           </div>
...
//             {/* Loading Progress */}
//             {loading && (
//               <div className="mb-8 lg:mb-10 xl:mb-12 bg-gradient-to-r from-blue-50/90 to-fuchsia-50/90 border-2 border-blue-200/50 rounded-3xl p-6 lg:p-8 xl:p-10 shadow-2xl shadow-blue-500/10 backdrop-blur-xl">
//                 <div className="flex items-center justify-center">
//                   <div className="flex-shrink-0 animate-spin rounded-full h-12 w-12 lg:h-14 lg:w-14 border-4 border-blue-500/30 border-t-blue-600"></div>
//                   <div className="ml-6 lg:ml-8 text-center">
//                     <p className="text-lg lg:text-xl xl:text-2xl font-bold text-blue-800">
//                       {getLoginStepMessage()}
//                     </p>
//                     <div className="w-full bg-blue-200/50 rounded-full h-2 mt-4">
//                       <div 
//                         className="bg-gradient-to-r from-blue-600 to-fuchsia-600 h-2 rounded-full shadow-lg animate-pulse"
//                         style={{ width: loginStep === 'success' ? '100%' : loginStep === 'verifying' ? '85%' : loginStep === 'authenticating' ? '60%' : '30%' }}
//                       ></div>
//                     </div>
...
//             {/* Success Message */}
//             {success && (
//               <div className="mb-8 lg:mb-10 xl:mb-12 bg-gradient-to-r from-emerald-50 to-fuchsia-50/80 border-2 border-emerald-200/50 rounded-3xl p-6 lg:p-8 xl:p-10 shadow-2xl shadow-emerald-500/10 backdrop-blur-xl animate-bounce">
//                 <div className="flex items-center justify-center">
//                   <div className="flex-shrink-0">
//                     <svg className="h-12 w-12 lg:h-14 lg:w-14 text-emerald-500 animate-pulse" viewBox="0 0 20 20" fill="currentColor">
//                       <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
//                     </svg>
//                   </div>
//                   <div className="ml-6 lg:ml-8 text-center">
//                     <p className="text-2xl lg:text-3xl xl:text-4xl font-black text-emerald-800">
//                       🎉 Authentication Successful!
//                     </p>
//                     <p className="text-lg lg:text-xl text-emerald-700 mt-2 font-semibold">
//                       Welcome back, Muluken Walle Hibste 👋
//                     </p>
...
//             {/* Error Message */}
//             {error && (
//               <div className="mb-8 lg:mb-10 xl:mb-12 bg-gradient-to-r from-rose-50/90 to-fuchsia-50/90 border-2 border-rose-200/50 rounded-3xl p-6 lg:p-8 xl:p-10 shadow-2xl shadow-rose-500/10 backdrop-blur-xl">
//                 <div className="flex items-start">
//                   <div className="flex-shrink-0 mt-1">
//                     <svg className="h-10 w-10 lg:h-12 lg:w-12 text-rose-500" viewBox="0 0 20 20" fill="currentColor">
//                       <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
//                     </svg>
//                   </div>
//                   <div className="ml-4 lg:ml-6">
//                     <p className="text-lg lg:text-xl xl:text-2xl font-bold text-rose-800 whitespace-pre-line">{error}</p>
//                     <button 
//                       onClick={() => window.location.reload()} 
//                       className="mt-4 inline-flex items-center px-4 py-2 bg-gradient-to-r from-rose-600 to-pink-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
//                     >
//                       🔄 Retry Login
//                     </button>
//                   </div>
...
//                       value={formData.password}
//                       onChange={handleChange}
//                       className="w-full pl-12 lg:pl-14 xl:pl-16 pr-12 lg:pr-14 xl:pr-16 py-4 lg:py-5 xl:py-6 border-2 border-fuchsia-800/20 bg-gradient-to-r from-rose-700/5 via-white/95 to-fuchsia-800/5 rounded-2xl focus:ring-4 focus:ring-rose-800/30 focus:border-rose-800 transition-all duration-300 shadow-lg hover:shadow-xl hover:border-fuchsia-800/40 text-base lg:text-lg xl:text-xl placeholder-rose-700/60 font-medium"
//                       placeholder="Enter your CBE password"
//                       disabled={loading}
//                       required
//                       autoComplete="current-password"
...
//                   )}
//                   <span className="relative z-10 flex items-center">
//                     {loading ? '🌐 Connecting to CBE LDAP...' : '🚀 Sign In to CBE KYC'}
//                   </span>
//                 </button>
//               </form>
//             </div>
